...
data_file = 'data/a12m220XL_a_avg_srcs0-7.h5'
...
corr_lst = {
    ...
    'proton':{
        'dsets':[
            'gf1p0_w3p0_n30_M51p2_L512_a1p5/spec/ml0p00600/proton/px0_py0_pz0/spin_up',
            'gf1p0_w3p0_n30_M51p2_L512_a1p5/spec/ml0p00600/proton/px0_py0_pz0/spin_dn',
            'gf1p0_w3p0_n30_M51p2_L512_a1p5/spec/ml0p00600/proton_np/px0_py0_pz0/spin_up',
            'gf1p0_w3p0_n30_M51p2_L512_a1p5/spec/ml0p00600/proton_np/px0_py0_pz0/spin_dn',
            ],
        'weights'  :[0.25, 0.25, 0.25, 0.25],
        't_reverse':[False, False, False, False],
        'phase'    :[1, 1, 1, 1],
        'fold'     :False,
        'snks'     :['S', 'P'],
        'srcs'     :['S'],
    ...
    # PION
    'pion':{
        'dsets':['gf1p0_w3p0_n30_M51p2_L512_a1p5/spec/ml0p00600/piplus/px0_py0_pz0/corr'],
        'weights'  :[1],
        't_reverse':[False],
        'fold'     :True,
        'snks'     :['S', 'P'],
